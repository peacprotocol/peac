...
| `@peac/adapter-runtime-governance` | 6 observation-specific type URIs, first runtime-governance mapper, session summary; composition recipe: [runtime governance composition](SOLUTIONS/agt-peac-composition.md) | v0.12.10 | **Shipped** | `conformance-fixture-only` [e2] |
