...
```json
{
  "type": "https://peacprotocol.org/problems/{error-code}",
...
```json
{
  "type": "https://peacprotocol.org/problems/unknown-kid",
...
```json
{
  "type": "https://peacprotocol.org/problems/policy-precondition-failed",
...
```json
{
  "type": "https://peacprotocol.org/problems/crypto-operation-failed",
...
```json
{
  "type": "https://peacprotocol.org/problems/upstream-provider-error",
...
```json
{
  "type": "https://peacprotocol.org/problems/rail-unavailable",
...
```json
{
  "type": "https://peacprotocol.org/problems/discovery-timeout",
...
| ----------------- | ----------- | ------------------------------------------------------------ |
| Schema Validation | 400         | https://peacprotocol.org/problems/schema-validation-failed   |
| Invalid Signature | 401         | https://peacprotocol.org/problems/invalid-proof              |
| Unknown KID       | 401         | https://peacprotocol.org/problems/unknown-kid                |
| Payment Required  | 402         | https://www.rfc-editor.org/rfc/rfc9110.html#status.402       |
| Policy Failed     | 422         | https://peacprotocol.org/problems/policy-precondition-failed |
| Rate Limited      | 429         | https://peacprotocol.org/problems/rate-limited               |
| Crypto Failed     | 500         | https://peacprotocol.org/problems/crypto-operation-failed    |
| Provider Error    | 502         | https://peacprotocol.org/problems/upstream-provider-error    |
| Rail Unavailable  | 503         | https://peacprotocol.org/problems/rail-unavailable           |
| Timeout           | 504         | https://peacprotocol.org/problems/discovery-timeout          |
