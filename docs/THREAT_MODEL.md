...
| T-SHDW-05 | Shadow path executes when flag unset                       | Lazy `import('@peac/resolver-http')` only when `PEAC_INTERNAL_SHADOW_RESOLVER === '1'`; default OFF; module never loaded otherwise    | [`apps/api/tests/shadow-resolver.boundary.test.ts`](../apps/api/tests/shadow-resolver.boundary.test.ts)                                                                                                  |
