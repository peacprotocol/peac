...
| MCP tool evidence                   | Tool invocation records with `_meta` namespaced under `org.peacprotocol/*`                    | Anthropic MCP, GitHub Copilot MCP, other MCP clients                     | [`../specs/MCP-EVIDENCE-PROFILE.md`](../specs/MCP-EVIDENCE-PROFILE.md)                 |
