...
| --------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| **Upstream specification**  | x402 protocol (Linux Foundation hosted; v2 stable, v1 legacy with dual-header read)                                                       | `draft-ryan-httpauth-payment-01` (active Internet-Draft)                                                                                          | Agentic Commerce Protocol API-Version `2026-01-30` (OpenAI / Stripe)                                          |
