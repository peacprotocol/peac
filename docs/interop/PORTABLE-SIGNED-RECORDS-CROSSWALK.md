...
| Monetized resource payments (HTTP 402)  | records of x402 offers, payments, and settlement observations | [`docs/guides/x402-peac.md`](../guides/x402-peac.md), [`examples/x402-upto-evidence/`](../../examples/x402-upto-evidence/), [`docs/SOLUTIONS/cloudflare-x402-peac.md`](../SOLUTIONS/cloudflare-x402-peac.md) |
...
| Monetized resource payments (HTTP 402)  | open protocol                      | x402 (x402.org); x402-foundation/x402 Signed Offers and Receipts extension, spec_version 0.6                          | 2026-07-05   | PEAC does not settle payments, price resources, or verify scheme invariants; it preserves x402's payment-native signed artifacts inside portable records.                                        |
