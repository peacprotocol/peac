 ...
 *
 * Places carrier data under metadata[PEAC_EXTENSION_URI] per the A2A
 * extension-URI metadata convention (inherited from v0.3.0 and carried
 * forward in v1.0.0). Uses computeReceiptRef() from @peac/schema for
 * receipt reference computation.
 */
