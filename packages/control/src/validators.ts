 ...
 */
export const TemporalConstraintSchema = TemporalConstraintBaseSchema.refine((data) => {
  // At least one temporal constraint must be specified
  return data.valid_from !== undefined ||
 ...
 */
export const UsageConstraintSchema = UsageConstraintBaseSchema.refine((data) => {
 ...
 */
export const BudgetConstraintSchema = BudgetConstraintBaseSchema.refine((data) => {
 ...
 */
export const CombinedConstraintSchema = CombinedConstraintBaseSchema.refine((data) => {
  // At least one mandate type must be specified
  return data.temporal !== undefined ||
