...
describe('Receipts Module', () => {
  ...
  describe('verifyReceipt', () => {
    ...
    it('should validate receipt claims', async () => {
      ...
      const expiredReceipt = 'eyJhbGciOiJFZERTQSIsInR5cCI6ImFwcGxpY2F0aW9uL3BlYWMtcmVjZWlwdCtqd3MiLCJraWQiOiJrZXlfMTIzIn0.eyJpc3MiOiJodHRwczovL2V4YW1wbGUuY29tIiwiYXVkIjoiaHR0cHM6Ly9hcGkuZXhhbXBsZS5jb20iLCJpYXQiOjE2OTQwODMyMDAsImV4cCI6MTY5NDA4MzIwMSwicGF0aCI6Ii9hcGkvdGVzdCIsIm1ldGhvZCI6IkdFVCIsInN0YXR1cyI6MjAwfQ.mockSignature';
    ...
    it('should handle missing required claims', async () => {
      ...
      const incompleteReceipt = 'eyJhbGciOiJFZERTQSIsInR5cCI6ImFwcGxpY2F0aW9uL3BlYWMtcmVjZWlwdCtqd3MiLCJraWQiOiJrZXlfMTIzIn0.eyJpc3MiOiJodHRwczovL2V4YW1wbGUuY29tIiwiYXVkIjoiaHR0cHM6Ly9hcGkuZXhhbXBsZS5jb20iLCJpYXQiOjE2OTQwODMyMDAsImV4cCI6MTY5NDA4Njg0MCwibWV0aG9kIjoiR0VUIiwic3RhdHVzIjoyMDB9.mockSignature';
    ...
    it('should validate receipt type header', async () => {
      ...
      const wrongTypeReceipt = 'eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCIsImtpZCI6ImtleV8xMjMifQ.eyJpc3MiOiJodHRwczovL2V4YW1wbGUuY29tIiwiYXVkIjoiaHR0cHM6Ly9hcGkuZXhhbXBsZS5jb20iLCJpYXQiOjE2OTQwODMyMDAsImV4cCI6MTY5NDA4Njg0MCwicGF0aCI6Ii9hcGkvdGVzdCIsIm1ldGhvZCI6IkdFVCIsInN0YXR1cyI6MjAwfQ.mockSignature';
