...
export const PEAC_ATTRS = {
  ...
  RECORD_REF: 'peac.record.ref',

  /**
   * @deprecated `peac.receipt.ref` remains dual-emitted for one minor release window
   * for compatibility. New consumers should read `peac.record.ref`.
   */
