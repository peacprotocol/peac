...
module.exports = {
  ...
  coveragePathIgnorePatterns: [
    ...
    '<rootDir>/src/http/export.ts',
    '<rootDir>/src/security/headers.ts',
    '<rootDir>/src/telemetry/log.ts',
    '<rootDir>/src/core/ratelimit.ts',
    '<rootDir>/src/rate/limits.ts',
    '<rootDir>/src/receipts/jcs.ts',
    '<rootDir>/src/middleware/error.ts',
    '<rootDir>/src/middleware/rateLimit.ts',
    '<rootDir>/src/middleware/token-bucket-rate-limit.ts',
    '<rootDir>/src/utils/resource-matcher.ts',
  ],
  coverageThreshold: {
