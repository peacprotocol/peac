...
| [`gateway-decision-evidence`](./gateway-decision-evidence/)                     | Terminal gateway access decisions, mandatory non-issuance for intermediate/check/handling states, and profile-strict offline issuer/key-policy verification.      |
